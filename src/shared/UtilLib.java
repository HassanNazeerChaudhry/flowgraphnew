...
public class UtilLib {
    ...
    public static String getJarFolder() {
        try {
            return new File(UtilLib.class.getProtectionDomain().getCodeSource().getLocation().toURI()).toPath().getParent().toString() + File.separator;
    ...
    public static String getAkkaConfPath(String file) {
        ...
        String protocol = UtilLib.class.getResource("").getProtocol();
