...
//        Parameter firstParameter = new Parameter("v31694","Hello");
//        Parameter secondParameter = new Parameter("v7576","Hello");
//        Parameter thirdParameter = new Parameter("v7576","Hi");
//        Parameter forthParameter = new Parameter( "v81109","Hi");
//        Parameter fifthParameter = new Parameter( "v81109","Hii");
//        ArrayList<Long> windows = new ArrayList<>();
//
//        InputEvent A = new InputEvent(InputEvent.EventEnum.VERTEX_ADDITION,
//                new ArrayList<>(Arrays.asList(firstParameter)),new EventIdValue(firstParameter.getId()));
//        InputEvent B = new InputEvent(InputEvent.EventEnum.VERTEX_UPDATE,
//                new List<>(Arrays.asList(secondParameter, thirdParameter)),new EventIdValue(secondParameter.getId()));
//        windows.add(TimeUnit.MINUTES.toMillis(5));
//        InputEvent C = new InputEvent(InputEvent.EventEnum.VERTEX_ADDITION,
//                new ArrayList<>(Arrays.asList(fifthParameter)),new EventIdValue(fifthParameter.getId()));
//        windows.add(TimeUnit.MINUTES.toMillis(3));
//        InputEvent D = new InputEvent(InputEvent.EventEnum.VERTEX_UPDATE,
//                new ArrayList<>(Arrays.asList(fifthParameter, forthParameter)),new EventIdValue(fifthParameter.getId()));
//        windows.add(TimeUnit.MINUTES.toMillis(2));
//
//
//        Sequence sequence = new Sequence(trigger,streamParser.genVar,callback,new ArrayList<>(Arrays.asList(A,B,C,D)), windows);
